...
12. Remaining high-value surfaces: personal settings (`/settings/profile`, `/settings/notifications`, `/settings/tokens`, `/settings/keys`), organization/team admin, branch/commit history details, Insights/Security overview, wiki/projects/discussions if scope remains.

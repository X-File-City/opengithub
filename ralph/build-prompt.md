...
## Visual Design — Editorial, NOT GitHub

**Critical**: this product clones GitHub's *capabilities* (repos, PRs, issues, Actions, etc.) but ships with the **Editorial** design system — a calm, magazine-grade aesthetic with warm cream paper, ink black text, single rust accent, and Fraunces / Inter Tight / JetBrains Mono typography. **Do NOT copy GitHub's visuals** (no blue `#0969da`, no green `#1f883d`, no red `#cf222e`, no Octicons, no Primer chrome).
